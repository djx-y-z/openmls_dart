    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::DcoCodec, _>(
        ...
        move || {
            ...
            transform_result_dco::<_, _, ()>((move || {
                ...
                let api_that_guard = api_that_guard.unwrap();
                let output_ok =
                    Ok::<_, ()>(crate::api::engine::MlsEngine::is_closed(&*api_that_guard))?;
                std::result::Result::Ok(output_ok)
            })())
        },
    )
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::DcoCodec, _>(
        ...
        move || {
            ...
            transform_result_dco::<_, _, ()>((move || {
                ...
                let api_that_guard = api_that_guard.unwrap();
                let output_ok = Ok::<_, ()>(crate::api::engine::MlsEngine::schema_version(
                    &*api_that_guard,
                ))?;
                std::result::Result::Ok(output_ok)
            })())
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::DcoCodec, _>(
        ...
        move || {
            ...
            transform_result_dco::<_, _, ()>((move || {
                ...
                let api_that_guard = api_that_guard.unwrap();
                let output_ok = Ok::<_, ()>(crate::api::keys::MlsSignatureKeyPair::private_key(
                    &*api_that_guard,
                ))?;
                std::result::Result::Ok(output_ok)
            })())
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::DcoCodec, _>(
        ...
        move || {
            ...
            transform_result_dco::<_, _, ()>((move || {
                ...
                let api_that_guard = api_that_guard.unwrap();
                let output_ok = Ok::<_, ()>(crate::api::keys::MlsSignatureKeyPair::public_key(
                    &*api_that_guard,
                ))?;
                std::result::Result::Ok(output_ok)
            })())
...
fn wire__crate__api__config__mls_group_config_default_config_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::DcoCodec, _>(
        ...
        move || {
            let api_ciphersuite = ciphersuite.cst_decode();
            transform_result_dco::<_, _, ()>((move || {
                let output_ok = Ok::<_, ()>(crate::api::config::MlsGroupConfig::default_config(
                    api_ciphersuite,
                ))?;
                std::result::Result::Ok(output_ok)
            })())
...
fn wire__crate__api__types__supported_ciphersuites_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::DcoCodec, _>(
        ...
        move || {
            transform_result_dco::<_, _, ()>((move || {
                let output_ok = Ok::<_, ()>(crate::api::types::supported_ciphersuites())?;
                std::result::Result::Ok(output_ok)
            })())
        },
    )
